...
- The configured workflow will check the code style for each push and PR. (**Check RFC about
  prettier: https://github.com/cawa-93/vite-electron-builder/pull/821**)
- **Automatic tests**
