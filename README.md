...
2. If you want to use another package manager you may need to edit [`.github/workflows`]([/.github/workflows](https://github.com/search?q=npm+repo%3Acawa-93%2Fvite-electron-builder+path%3A.github%2Fworkflows&type=Code)) since npm is used as default. (See also https://github.com/cawa-93/vite-electron-builder/issues/944)
   > **Note**:
